export const properties = [
...

  {
    ...
    Madinat Jumeirah Living is a prime residential community in the Jumeirah district, by master-developer Dubai Holding.
     Made up of a few dozen mid-rise buildings, MJL offers unsurpassed views of the sea and the city’s iconic skyline.
  ...
  },
  {
    ...
    overview: `MarketMagnet is offering an opportunity to invest in a 2-bedroom apartment in 29 Boulevard, in Downtown Dubai.  
      ...
      The world-famous Downtown Dubai is a 2 km² district filled with numerous residential towers, office buildings, tourist attractions, shopping malls, and entertainment hotspots. The area is home to the Dubai Mall, the largest fountain in the world, and the tallest tower in the world: the Burj Khalifa`,
  },
  {
    id: 6,
