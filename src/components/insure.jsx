...
function Insure() {
  return (
    <section className="wrapper_1">
      ...
      {/* hero section 1 */}
      <div className="hero_seaction_1 w-full mt-20 ">
      ...
      <div className="hero_seaction_2 w-full  mt-24 ">
        <div className="hero_section_child1  flex justify-around w-full p-20">
          ...
          <div className="">
            ...
            <p className="text-[24px] text-[#707070]">
              Be it Life, Motor or Health insurance, compare insurance<br></br>{" "}
              plans across 35+ insurers
            </p>
          </div>
